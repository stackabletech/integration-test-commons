...
:6: https://github.com/stackabletech/integration-test-commons/pull/6[#6]
...
=== Changed
* Dependency `k8s-openapi` set to version `0.12` ({6}).
* Dependency `kube` set to version `0.57` ({6}).
* Dependency `tokio` set to version `1.8` ({6}).
